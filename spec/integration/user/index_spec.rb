...
RSpec.describe 'User Index', type: :feature do
  before(:each) do
    @user1 = User.create(name: 'Keya Payel', image: 'https://example.jpg',
                         bio: 'She is an actress', posts_counter: 1)
    @user2 = User.create(name: 'Tania Bristy', image: 'https://example.jpg',
  ...
  it 'Redirect to the users show page when clicking on a user.' do
