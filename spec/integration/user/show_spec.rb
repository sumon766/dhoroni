...
RSpec.describe 'Show Page', type: :feature do
  before(:each) do
    ...
    @post2 = Post.create(title: 'test post-1', description: 'test text-1', comments_counter: 1,
                         likes_counter: 2, author_id: @user.id)
    @post3 = Post.create(title: 'test post-1', description: 'test text-1', comments_counter: 1,
                         likes_counter: 2, author_id: @user.id)
    @post4 = Post.create(title: 'test post-1', description: 'test text-1', comments_counter: 1,
                         likes_counter: 2, author_id: @user.id)
